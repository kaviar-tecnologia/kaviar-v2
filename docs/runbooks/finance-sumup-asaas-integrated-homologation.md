...
- **Asaas**: saldo para saída vem exclusivamente do GET autenticado de saldo
  ...
  separadamente. Obrigações bloqueadas e tentativas incertas entram no orçamento
  conservador de compromissos até conciliação definitiva, mas aparecem em
  indicador próprio ("bloqueadas / em conciliação"), distinto de "em trânsito".
