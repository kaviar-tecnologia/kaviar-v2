              ...
              <TableBody>
                {operators.map(o => {
                  ...
                  <TableRow key={o.id}>
                    ...
                    <TableCell>{isManager ? <Chip label={o.financial_activation?.label || 'Não ativa'} size="small" color={o.financial_activation?.active ? 'success' : ['suspended', 'blocked'].includes(o.financial_activation?.key) ? 'warning' : 'default'} /> : '—'}</TableCell>
