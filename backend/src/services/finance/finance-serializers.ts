...
export function serializeCategoryItem(category: any) {
  return {
    ...
    is_postable: category.is_postable,
    sort_order: category.sort_order,
    accounting_code: category.accounting_code ?? null,
    accounting_nature: category.accounting_nature ?? null,
    dre_group: category.dre_group ?? null,
    balance_sheet_group: category.balance_sheet_group ?? null,
    fiscal_classification: category.fiscal_classification ?? null,
    deductible: category.deductible ?? null,
    export_code: category.export_code ?? null,
    accountant_notes: category.accountant_notes ?? null,
