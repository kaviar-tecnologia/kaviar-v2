  ...
  try {
    ...
    res.json({ success: true, data: {
      ...
      driver: ride.driver ? {
        ...
        has_excellence_seal: !!(await prisma.driver_badges.findUnique({ where: { driver_id_badge_type: { driver_id: ride.driver.id, badge_type: 'EXCELLENCE_SEAL' } }, select: { progress: true } }))?.progress,
      } : null,
    } });
  } catch (error: any) {
